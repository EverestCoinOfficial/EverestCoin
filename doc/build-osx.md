# Mac OS X Everestd Build Instructions
...
* See readme-qt.rst for instructions on building Everest QT, the
...
## Useful commands
    ...
    ./everestd --help  # for a list of command-line options.
    ./everestd -daemon # to start the everest daemon.
    ./everestd help    # When the daemon is running, to get a list of RPC commands
